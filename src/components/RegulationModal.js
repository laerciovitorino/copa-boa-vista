...
const RegulationModal = (props) => (
  ...
  >
    ...
    automaticamente eliminado. Como não houve campeonato em 2018, este ano não temos jogadores ou equipes punido(s)
    ou punida(s), para esta competição de 2019.</p>
